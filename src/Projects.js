     ...
     <div className="d-flex flex-column">
        <div className="education-one my-4 justify-content-between d-flex flex-row">
          <div className="d-flex flex-column new-one">
            <span className="project-name">
              CreatiSketch{" "}
              <span className="project-subtext">A collaborative online drawing tool</span>
            </span>
        ...
        <div className="education-one my-4 justify-content-between d-flex flex-row">
          <div className="d-flex flex-column new-one">
            <span className="project-name">
              SocialSphere{" "}
              <span className="project-subtext">A social media web application</span>
            </span>
            <span className="tech-used">
              Tech Used: MERN Stack, Rest-API{" "}
            </span>
          </div>{" "}
          <div>
